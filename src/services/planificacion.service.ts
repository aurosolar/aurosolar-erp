...
export async function listarEventos(filtros?: {
  ...
  const obras = await prisma.obra.findMany({
    where: {
      ...
      estado: { in: ['PROGRAMADA', 'INSTALANDO', 'TERMINADA'] },
